...
cp "$SRC/app-arm64-v8a-release.apk" "$FDROID_REPO/dev.cacing69.radar_emas-arm64-v8a.apk"
cp "$SRC/app-armeabi-v7a-release.apk" "$FDROID_REPO/dev.cacing69.radar_emas-armeabi-v7a.apk"
cp "$SRC/app-x86_64-release.apk" "$FDROID_REPO/dev.cacing69.radar_emas-x86_64.apk"
...
#   FDROID_CHANGELOG_FILE="$FDROID_REPO/dev.cacing69.radar_emas/en-US/changelogs/$NEW_BUILD.txt"
...
echo "Done: radar_emas $NEW_VERSION released"
